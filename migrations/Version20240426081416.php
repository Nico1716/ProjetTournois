 ...
 */
final class Version20240426081416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meetings (id INT AUTO_INCREMENT NOT NULL, tournament_id INT DEFAULT NULL, date DATETIME NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_44FE52E233D1A3E7 (tournament_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE point (id INT AUTO_INCREMENT NOT NULL, team_id INT DEFAULT NULL, points INT NOT NULL, INDEX IDX_B7A5F324296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, ranking_id INT DEFAULT NULL, player_id INT DEFAULT NULL, team_name VARCHAR(100) NOT NULL, INDEX IDX_C4E0A61F20F64684 (ranking_id), INDEX IDX_C4E0A61F99E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE meetings ADD CONSTRAINT FK_44FE52E233D1A3E7 FOREIGN KEY (tournament_id) REFERENCES tournament (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE meetings DROP FOREIGN KEY FK_44FE52E233D1A3E7');
